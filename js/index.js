...
// imgplay
	$('.mx-index-topItem-detail a').hover(function(){
		$(this).parents('li').find('.mx-index-topItem-detail-imgbox img').removeClass('imgplayout')
		$(this).parents('li').find('.mx-index-topItem-detail-imgbox img').addClass('imgplay')
	})
	$('.mx-index-topItem-detail a').mouseleave(function(){
		$(this).parents('li').find('.mx-index-topItem-detail-imgbox img').removeClass('imgplay')
		$(this).parents('li').find('.mx-index-topItem-detail-imgbox img').addClass('imgplayout')
...
// a ADD _blank
	var anchors = document.getElementsByTagName("a"); 
		for(var i=0;i<anchors.length;i++){ 
			...
			if(anchor_item.href != "javascript:;"){
				anchor_item.target="_blank"; 
				// temp
				// anchor_item.href="index.html"; 
		}
	} 
